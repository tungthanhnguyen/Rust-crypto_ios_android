...
void rust_crypto_aesni_setup_working_key_128(uint8_t* key,
                                             uint8_t* round_key)
{
	#ifdef __SSE__
		asm volatile(
...
void rust_crypto_aesni_setup_working_key_192(uint8_t* key,
                                             uint8_t* round_key)
{
	#ifdef __SSE__
		asm volatile(
...
void rust_crypto_aesni_setup_working_key_256(uint8_t* key,
                                             uint8_t* round_key)
{
	#ifdef __SSE__
		asm volatile(
...
void rust_crypto_aesni_setup_working_key_512(uint8_t* key,
                                             uint8_t* round_key)
{
	#ifdef __SSE__
		asm volatile(
...
void rust_crypto_aesni_setup_working_key_1024(uint8_t* key,
                                              uint8_t* round_key)
{
	#ifdef __SSE__
		asm volatile(
...
void rust_crypto_aesni_encrypt_block(uint8_t rounds,
                                     uint8_t* input,
                                     uint8_t* round_keys,
                                     uint8_t* output)
{
...
void rust_crypto_aesni_decrypt_block(uint8_t rounds,
                                     uint8_t* input,
                                     uint8_t* round_keys,
                                     uint8_t* output)
{
